...
<div id="wrap">
	...
	<div id="content">
		...
		<div id="processing">
			...
			$result = 0;
			if(isset($id) &&isset($category_id) && isset($detail) && isset($time) && isset($amount))
			{
				$result = submit_edit_record($id, $category_id, $detail, $time, $amount, $description);
			}
			
			if($result)
			{
				echo "<p><b>Updating record...</b></p>";
			}
			else
			{
