...
{
	$available_money = CStatistic::GetAvailableMoney();
...
{
	return CRecordManager::DeleteRecord($_POST['id']);
}

function confirmDeleteDetail()
{
	$record = CRecordManager::GetRecordById($_GET['id']);
...
DLOG("action_type=$action_type");
switch($action_type)
{
case "filter":
	apply_filter(isset($_POST['enable_filter']) ? $_POST['enable_filter'] : null);
case "list":
